...
public class HybridTrieTest extends AbstractTrieTest {
	private static final String EXAMPLE_PATH = "triesalgav/files/exerciseExample.txt";
	...
	public final void testToPatriciaTrie() {
		...
		assertTrue("insert balanced", patriciaTrie.getStoredWords().equals(patriciaTrieFromHT.getStoredWords()));
	}
}
