...
public class DataStatistics {
    ...
    // Eclipse IDE
    private final static String RESULTS_PATH = "results/data_statistics.txt";
    // IntelliJ IDE
    //private final static String RESULTS_PATH = "AlgavDevoirProgrammation/results/data_statistics.txt";
